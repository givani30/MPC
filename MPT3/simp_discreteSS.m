function [sys, U,Y,X,DX] = simp_discreteSS(eps, u, params,Ts)
    ...
    % Extract states
    Y = eps(1); % The velocity of the car in the x direction
    psi = eps(2); % The angular velocity of the car around the z axis
    V= eps(3); % The angle between the body frame and the x axis
